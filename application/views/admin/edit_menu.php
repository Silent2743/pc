...
<html lang="en">
  <head>
    ...
    <title>Halaman Edit Data Menu</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url('Menu/save_update/'.$data->id_menu); ?>">

                     
                      <span class="section">Data Menu</span>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" ">Kode Menu<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12"  placeholder="Kode Menu" required="required" name="kd_menu" value="<?= $data->kd_menu; ?>" >
                        </div>
                      </div>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" ">Kategori Menu<span required="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" required="required" class="form-control col-md-7 col-xs-12"  placeholder="Kategori Menu (lihat di buku)" name="kt_menu" value="<?= $data->kt_menu; ?>">
                        </div>
                      </div>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Isi Menu<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  class="form-control col-md-7 col-xs-12"  placeholder="Isi Menu" required="required" name="isi_menu" value="<?= $data->isi_menu; ?>">
                        </div>
                      </div>
