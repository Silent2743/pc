...
<html lang="en">
  <head>
    ...
    <title>Halaman Edit Data Rias</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url('Rias/save_update/'.$data->kd_rs); ?>">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12"  placeholder="Kode Rias" required="required" name="kd_rs" value="<?= $data->kd_rs; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" required="required" class="form-control col-md-7 col-xs-12"  placeholder="Nama Rias" name="nm_rias" value="<?= $data->nm_rias; ?>">
                        </div>
                      </div>
