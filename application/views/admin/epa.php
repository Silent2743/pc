                ...
                <div class="x_panel">
                  <div class="x_title">
                   ...
                   <div style="float: right">
                     <a href="<?= base_url(); ?>EPA/add_epa" class="btn btn-primary">Tambah Admin</a>
                   </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href=" <?= base_url('EPA/update_epa/'.$items->username); ?>" class="btn btn-warning">Edit <i class ="fa fa-edit"></i></a>
              <a href=" <?= base_url('EPA/delete/'.$items->username); ?>" class="btn btn-danger">Delete <i class ="fa fa-edit"></i></a>
            </td>
          </tr>
        <?php endforeach;?>
        </tbody>
