...
<html lang="en">
  <head>
    ...
    <title>Halaman Tambah Data Admin</title>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST">
                      ...
                      <span class="section">Data Admin</span>
                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  class="form-control col-md-7 col-xs-12"  placeholder="Password" required="required" name="password" value="<?= $password; ?>" type="password">
                        </div>
                      </div>
