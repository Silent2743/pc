...
<html lang="en">
  <head>
    ...
    <title>Halaman Tambah Data Gedung</title>
                    ...
                    <form class="form-horizontal form-label-left" method="POST">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12"  placeholder="Kode Gedung" required="required" name="kd_gd" value="<?= $kd_gd;  ?>" >
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" required="required" class="form-control col-md-7 col-xs-12"  placeholder="Nama Gedung" name="nm_gedung" value="<?= $nm_gedung; ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  class="form-control col-md-7 col-xs-12"  placeholder="Alamat Lengkap Gedung" required="required" name="alamat" value="<?= $alamat; ?>">
                        </div>
                      </div>
