                ...
                <div class="x_panel">
                  <div class="x_title">
                   ...
                   <div style="float: right">
                     <a href="<?= base_url(); ?>Angg/add_angg" class="btn btn-primary">Tambah Anggota</a>
                   </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href=" <?= base_url('Angg/update_angg/'.$items->username); ?>" class="btn btn-warning">Edit <i class ="fa fa-edit"></i></a>
              <a href=" <?= base_url('Angg/delete/'.$items->username); ?>" class="btn btn-danger">Delete <i class ="fa fa-edit"></i></a>
            </td>
          </tr>
        <?php endforeach;?>
        </tbody>
