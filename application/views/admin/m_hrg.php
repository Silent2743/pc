                ...
                <div class="x_panel">
                  <div class="x_title">
                   ...
                   <div style="float: right">
                     <a href="<?= base_url(); ?>Harga/add_hrg" class="btn btn-primary">Tambah Harga</a>
                   </div>
      ...
      <table class = "table table-striped table-bordered dt-responsive nowrap" id="datatables">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?= 'Rp. '.number_format($items->hrg,0,',','.'); ?></td>
             
            <td>
              
              <a href=" <?= base_url('Harga/update_hrg/'.$items->id_hrg); ?>" class="btn btn-warning">Edit <i class ="fa fa-edit"></i></a>
              <a href=" <?= base_url('Harga/delete/'.$items->id_hrg); ?>" class="btn btn-danger">Delete <i class ="fa fa-edit"></i></a>
            </td>
          </tr>
        <?php endforeach;?>
        </tbody>
