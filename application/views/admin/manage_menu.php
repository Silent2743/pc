                ...
                <div class="x_panel">
                  <div class="x_title">
                   ...
                   <div style="float: right">
                     <a href="<?= base_url(); ?>Menu/add_menu" class="btn btn-primary">Tambah Menu</a>
                     <a href="<?= base_url(); ?>Paket" class="btn btn-primary">Halaman Paket</a>
                     <a href="<?= base_url(); ?>Harga" class="btn btn-primary">Halaman Harga</a>
                   </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="<?= base_url('Menu/update_menu/'.$item->id_menu); ?> " class="btn btn-warning">Edit <i class ="fa fa-edit"></i></a>
              <a href=" <?= base_url('Menu/delete/'.$item->id_menu); ?>" class="btn btn-danger">Delete <i class ="fa fa-edit"></i></a>
            </td>
          </tr>
        <?php endforeach;?>
        </tbody>
