...
<div class="row">
                ...
                <div class="x_panel">
                  <div class="x_title">
                   ...
                   <div style="float: right">
                     <a href="<?= base_url(); ?>Paket/add_paket" class="btn btn-primary">Tambah Paket</a>
                     <a href="<?= base_url(); ?>Menu" class="btn btn-primary">Halaman Menu</a>
                   </div>
      ...
      <table class = "table table-striped table-bordered dt-responsive nowrap" id="datatables">
        ...
        <tbody>
          <?php
          $k =1;
          foreach ($data->result() as $items2):
          ?>
          <tr>
            <td><?= $k++ ?></td>
            <td><?= $items2->id_paket; ?></td>
            <td><?= $items2->kd_paket; ?></td>
            <td><?= $items2->porsi; ?></td>
            <td>
              
              <a href=" <?= base_url('Paket/update_paket/'.$items2->id_paket); ?> " class="btn btn-warning">Edit<i class ="fa fa-edit"></i></a>
              <a href=" <?= base_url('Paket/delete/'.$items2->id_paket); ?>" class="btn btn-danger">Delete <i class ="fa fa-edit"></i></a>
            </td>
          </tr>
        <?php endforeach;?>
        </tbody>
