                ...
                <div class="x_panel">
                  <div class="x_title">
                   ...
                   <div style="float: right">
                     <a href="<?= base_url(); ?>Rias/add_rias" class="btn btn-primary">Tambah Rias</a>
                   </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href=" <?= base_url('Rias/update_rias/'.$items->kd_rs); ?>" class="btn btn-warning">Edit <i class ="fa fa-edit"></i></a>
              <a href=" <?= base_url('Rias/delete/'.$items->kd_rs); ?>" class="btn btn-danger">Delete <i class ="fa fa-edit"></i></a>
            </td>
          </tr>
        <?php endforeach;?>
        </tbody>
