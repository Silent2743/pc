                    ...
                    <form class="form-horizontal form-label-left" method="POST">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12"  placeholder="Kode Menu" required="required" name="kd_menu" value="<?= $kd_menu; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" required="required" class="form-control col-md-7 col-xs-12"  placeholder="Kategori Menu (lihat di buku)" name="kt_menu" value="<?= $kt_menu; ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  class="form-control col-md-7 col-xs-12"  placeholder="Isi Menu" required="required" name="isi_menu" value="<?= $isi_menu; ?>">
                        </div>
                      </div>
