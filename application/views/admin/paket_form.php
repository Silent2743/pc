                    ...
                    <form class="form-horizontal form-label-left" method="POST">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12"  placeholder="Id Paket" required="required" name="id_paket" value="<?= $id_paket; ?>" >
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" required="required" class="form-control col-md-7 col-xs-12"  placeholder="Kode Paket" name="kd_paket" value="<?= $kd_paket; ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  class="form-control col-md-7 col-xs-12"  placeholder="Jumlah Porsi" required="required" name="porsi" value="<?= $porsi; ?>">
                        </div>
                      </div>
