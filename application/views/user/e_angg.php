              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo base_url('User/save_angg/'); ?>">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12"  placeholder="Username" required="required" name="username" value="<?php echo $this->session->userdata("username") ;?>" >
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="Password" required="required" class="form-control col-md-7 col-xs-12"  placeholder="Password" name="pass" value="<?php echo $this->session->userdata("pass");?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  class="form-control col-md-7 col-xs-12"  placeholder="Nama" required="required" name="nama" value="<?php echo $this->session->userdata("nama");?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  class="form-control col-md-7 col-xs-12"  placeholder="Alamat" required="required" name="alamat" value="<?php echo $this->session->userdata("alamat");?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  class="form-control col-md-7 col-xs-12"  placeholder="Jenis Kelamin" required="required" name="jen_kel" value="<?php echo $this->session->userdata("jen_kel");?>">
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  class="form-control col-md-7 col-xs-12"  placeholder="No. Telpon" required="required" name="no_telp" value="<?php echo $this->session->userdata("no_telp");?>">
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  class="form-control col-md-7 col-xs-12"  placeholder="Email" required="required" name="email" value="<?php echo $this->session->userdata("email");?>">
                        </div>
                      </div>
