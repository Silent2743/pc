...
<div class="row">
      ...
      <table class = "table table-striped table-bordered dt-responsive nowrap" id="datatables">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?= $items->kd_rs; ?></td>
            <td>
              <a href=" <?= base_url('Laporan/delete/'.$items->username); ?>" class="btn btn-danger">Delete <i class ="fa fa-edit"></i></a>
            </td>
          </tr>
        <?php endforeach;?>
        </tbody>
    ...
    <h2 style="color: red">* Jika Anda Ingin Mengubah Paket, Silahkan Batalkan (delete) Pesanan Sebelumnya . Kemudian Lakukan Pemesanan Kembali. Terimakasih.
      <br> ** Anda Akan Dihubungi Oleh Pihak Kami Jika Sudah Memesan (Paling Lama 2 Hari Setelah Pemesanan)</h2>
</div>
</div>
</div>
</div>
    ...
    <script type="text/javascript">
      ...
      "search": {
        "search": "<?php echo ucwords($this->session->userdata("username") ); ?>"
      }
  } );
} );
    </script>
